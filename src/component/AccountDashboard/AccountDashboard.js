...
<div className="sm:px-12">
  ...
  <p className='text-[#59DCD3] my-2 tracking-wide text-[14px]'>
        ...
        <h1 className='text-[30px] sm:leading-[50px] mb-6 text-white	 sm:text-[50px] font-semibold '>Account Dashboard
            ...
            <div className="lg:absolute  lg:bottom-0 sm:flex sm:items-center lg:right-0">
            <Link to={'/link'}><button className='mb-4 sm:mb-0 text-white uppercase  rounded-none font-normal hover:bg-[#47a09a] outline-none py-2 px-[60px] text-[10px]  text-normal border-[1px] leading-[20px]  border-[#59DCD3]'>Link Crypto <br /> wallet</button></Link>

<Link to={'/link'}><button className=' text-white   uppercase mx-2  rounded-none font-normal hover:bg-[#47a09a] outline-none py-5 px-[60px] text-[10px]  text-normal border-[1px] leading-[20px]  border-[#59DCD3]'>Bet Now</button></Link>
       </div>
