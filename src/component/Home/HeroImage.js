      ...
      <div className='bg-[black] px-8 sm:px-12 py-12'>
          <div className="sm:px-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div className="flex items-center">
                  <div className="w-[252px] flex flex-col  items-center"><img className=' w-[120px] h-[120px]' src={david} alt="" /> <h1 className='mt-[-15px]'>Sign Up</h1></div>
...
the Losers Pool </h1></div>
              ...
              <div className="flex items-center mt-4">
                  <div className="w-[252px] flex flex-col justify-center items-center"><img className='w-[80px] h-[80px]' src={Hands} alt="" /> <h1 className='mt-6 '>Link Crypto Wallet</h1></div>
